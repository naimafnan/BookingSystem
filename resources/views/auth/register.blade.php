...
@section('content')
<div class="container">
    <div class="card mb-8" class="row justify-content-center">
        <div class="row no-gutters">
            <div class="col-md-4">
                <img src="/img/stats.jpg" class="card-img" alt="...">
            </div>
            <div class="col-md-8" >
                <div class="card-body" >
                    <h5 class="card-title" class="text-center">Register</h5>
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="password-confirm" type="password" class="form-control" name="password_confirmation" required autocomplete="new-password" placeholder="Enter Password to confirm ">
                            </div>
                        </div>
                        {{-- user can choose role when register --}}
                        <div class="form-group row">
